...
async function recoverPublicKey({ hash: hash3, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-WGJWMVI3.js");
  const signature_ = (() => {
...
async function internal_estimateFeesPerGas(client, args) {
  ...
  if (typeof ((_b = chain2 == null ? void 0 : chain2.fees) == null ? void 0 : _b.estimateFeesPerGas) === "function") {
    const fees2 = await chain2.fees.estimateFeesPerGas({
      block: block_,
      client,
      multiply,
      request,
...
async function prepareTransactionRequest(client, args) {
  const { account: account_ = client.account, blobs, chain: chain2, gas, kzg, nonce, nonceManager: nonceManager2, parameters = defaultParameters, type } = args;
    ...
    return withDedupe(() => withRetry(async () => {
      try {
        ...
        switch (err.code) {
          ...
          case UserRejectedRequestError2.code:
...
function assertTransactionEIP4844(transaction) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash3 of blobVersionedHashes) {
      ...
      const version = hexToNumber(slice(hash3, 0, 1));
      if (size_ !== 32)
...
async function signTransaction(client, parameters) {
  ...
  const formatters4 = (chain2 == null ? void 0 : chain2.formatters) || ((_a = client.chain) == null ? void 0 : _a.formatters);
  const format = ((_b = formatters4 == null ? void 0 : formatters4.transactionRequest) == null ? void 0 : _b.format) || formatTransactionRequest;
...
var htf = (() => createHasher(secp256k12.ProjectivePoint, (scalars) => {
...
// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/_assert.js
function number2(n) {
  if (!Number.isSafeInteger(n) || n < 0)
    throw new Error(`positive integer expected, not ${n}`);
}
...
// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/crypto.js
var crypto2 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/utils.js
...
// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/_md.js
...
// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/sha256.js
...
var sha2564 = wrapConstructor3(() => new SHA2562());
var sha2242 = wrapConstructor3(() => new SHA2242());

// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/viem/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/sha512.js
...
async function estimateGas2(client, args) {
  ...
  const account = parseAccount(account_);
  try {
    const { accessList, blockNumber, blockTag, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to, value, ...rest } = (account == null ? void 0 : account.type) === "local" ? await prepareTransactionRequest(client, args) : args;
    const blockNumberHex = blockNumber ? numberToHex(blockNumber) : void 0;
    const block = blockNumberHex || blockTag;
    assertRequest(args);
    const chainFormat = (_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionRequest) == null ? void 0 : _c.format;
...
var chainsMap = Object.values(chains_exports).reduce((acc, chain2) => Object.assign(Object.assign({}, acc), { [chain2.id]: chain2 }), {});
...
var estimateL1Fee2 = (publicClient, transaction) => __awaiter(void 0, void 0, void 0, function* () {
  const { chain: chain2 } = publicClient;
  if (!chain2) {
    throw new Error("Chain is not defined");
  }
  const publicClientWithChain = publicClient;
  if (opStackSupportedChains.includes(chain2.id)) {
...
var formatEther2 = (value, { precision } = {}) => formatNumberText(formatEther(value), { precision });
...
var ViemUiTransaction = class extends Eip1559FeeFeed {
  ...
  convertBigIntToHex(value) {
    return value ? toHex(value) : void 0;
  }
  estimateL1Fee() {
    return __awaiter(this, void 0, void 0, function* () {
      var _a;
...
var createViemUiTransaction = (_a) => __awaiter(void 0, [_a], void 0, function* ({ from, publicClient, walletClient }) {
...
var getChain = (chainId) => {
  for (const chain2 of Object.values(chains_exports)) {
    if ("id" in chain2) {
...
var getNameservice = (_a) => __awaiter(void 0, [_a], void 0, function* ({ rpcProvider, address }) {
  const nsData = {
    avatar: void 0,
    name: void 0
  };
...
var interceptTransport = ({ getAccounts, onPersonalSign, onSendTransaction, onSignTypedData, transport }) => (props) => {
...
// node_modules/@dynamic-labs/ethereum-core/src/connector/EthWalletConnector.js
var EthWalletConnector = class extends WalletConnectorBase {
  getPublicClient() {
    return __awaiter(this, void 0, void 0, function* () {
      var _a, _b;
  ...
  constructor(props) {
    ...
    this.evmNetworkRpcMap = () => this.evmNetworks.reduce((acc, network) => {
      var _a2;
      [acc[network.chainId]] = ((_a2 = network === null || network === void 0 ? void 0 : network.privateCustomerRpcUrls) === null || _a2 === void 0 ? void 0 : _a2.length) ? network.privateCustomerRpcUrls : network.rpcUrls;
      return acc;
    }, {});
  ...
  setActiveAccount(account) {
    this.activeAccount = account ? toAccount(account) : void 0;
  }
  getActiveAccount() {
    return this.activeAccount;
  }
  setActiveChain(chain2) {
    this.activeChain = chain2;
  }
  getActiveChain() {
...
ChainRpcProviders.getEvmProviderByChainId = (rpcProviders, chainId) => {
  var _a;
  const provider = (_a = rpcProviders["evm"]) === null || _a === void 0 ? void 0 : _a.find((provider2) => provider2.chainId === chainId);
  return provider;
};
...
var createAccountWithUiConfirmation = ({ address, account, provider, walletConnector, walletUiUtils }) => toAccount({
  address,
...
var createWalletClientWithUiConfirmation = ({ address, account, chain: chain2, transport, walletConnector, walletUiUtils }) => {
  let client = null;
  const provider = createPublicClient({
    chain: chain2,
    transport
...
*/
//# sourceMappingURL=chunk-G64M34PN.js.map
