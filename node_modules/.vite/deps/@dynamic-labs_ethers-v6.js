...
var _FetchResponse = class _FetchResponse {
  ...
  throwThrottleError(message, stall3) {
    ...
    defineProperties(error, { stall: stall3, throttle: true });
    throw error;
  }
  /**
...
var getRpcProvider = (wallet) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const network = {
    ...
    ensAddress: (_b = (_a2 = chain === null || chain === void 0 ? void 0 : chain.contracts) === null || _a2 === void 0 ? void 0 : _a2.ensRegistry) === null || _b === void 0 ? void 0 : _b.address,
