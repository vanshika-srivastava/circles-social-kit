...
const useExternalAuth = () => {
    ...
    /**
     * Uses a properly-configured non-Dynamic external JWT and user ID to verify the user in Dynamic.
     * When successful, this should verify the user's access to Dynamic's functionality
     * available to only signed-in users, such as wallet linking, etc.
     *
     * @param {string} props.externalJwt - JWT issued outside of Dynamic
     * @param {string} props.externalUserId - User ID to identify the user outside of Dynamic
     *
     * @returns {UserProfile} - User profile for successfully verified user
     */
