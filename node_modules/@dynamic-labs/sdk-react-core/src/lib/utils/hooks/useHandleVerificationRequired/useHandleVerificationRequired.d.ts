import { NextViewEnum, ProjectSettingsKyc, UpdateSelfResponse } from '@dynamic-labs/sdk-api-core';
...
export declare const getVerificationDestination: (nextView: NextViewEnum) => OtpDestination | undefined;
