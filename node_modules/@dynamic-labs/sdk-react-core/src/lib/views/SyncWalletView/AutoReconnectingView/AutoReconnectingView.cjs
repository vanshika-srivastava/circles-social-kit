...
var reconnectSocialWallet = require('../../../utils/hooks/useWalletConnectors/reconnectSocialWallet.cjs');
...
const AutoReconnectingView = ({ onCancel, onSuccess, connector, expectedAddress, }) => {
    ...
    usePromise.usePromise(() => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        if (walletConnectorCore.isSocialWalletConnector(connector)) {
            yield reconnectSocialWallet.reconnectSocialWallet(user, connector, expectedAddress, connector.connectedChain);
            onSuccess();
        }
    }), { deps: [connector] });
...
exports.AutoReconnectingView = AutoReconnectingView;
