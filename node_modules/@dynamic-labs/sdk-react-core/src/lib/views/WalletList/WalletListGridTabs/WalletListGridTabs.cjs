...
const WalletListGridTabs = ({ items, onSelect, value, }) => (jsxRuntime.jsx("div", { className: 'wallet-list-grid-tabs', children: items.map((item, index) => {
        ...
        const TabIcon = typeof icon === 'string' ? jsxRuntime.jsx("img", { src: icon, alt: text }) : icon;
        return (jsxRuntime.jsxs("button", { type: 'button', className: classNames.classNames('wallet-list-grid-tabs__button', {
            ...
            }), tabIndex: -1, "aria-label": text, onClick: () => onSelect(index), children: [TabIcon && (jsxRuntime.jsx(Icon.Icon, { size: 'small', className: classNames.classNames({
                        'wallet-list-grid-tabs__icon--selected': !selected,
                    }), children: TabIcon })), text && (jsxRuntime.jsx(Typography.Typography, { as: 'span', variant: 'body_small', weight: selected ? 'bold' : 'medium', color: selected ? 'primary' : 'secondary', children: text }))] }, key));
    }) }));
