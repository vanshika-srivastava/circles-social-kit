...
const DynamicWidgetHeader = ({ variant, }) => {
    ...
    return (jsxs("div", { className: 'dynamic-widget-header', children: [jsx(PasskeyCreatedSuccessBanner, { className: 'dynamic-widget-header__passkey-success' }), (overridenWidgetView === 'wallets' ||
                (overridenWidgetView === 'profile' && !multiWallet)) && (jsx(DynamicWidgetWalletHeader, { variant: variant }))] }));
};
