...
const AccordionItem = React.forwardRef(({ children, className = '', isOpen, dataTestId, dimOnHide = false, handleScroll = () => { }, }, ref) => {
    ...
    return (jsxRuntime.jsxs("div", { "data-testid": dataTestId, style: { maxHeight }, className: classNames.classNames(className, 'accordion-item', {
        ...
        }), onScroll: handleScroll, ref: ref, children: [dimOnHide && (jsxRuntime.jsx("div", { "data-testid": 'accordion-item-curtain', className: classNames.classNames('accordion-item__curtain', {
