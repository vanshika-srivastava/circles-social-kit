...
const Typography = (_a) => {
    var { as: Tag = 'p', variant, weight, color, transform, className = '', truncate = false, style } = _a, props = _tslib.__rest(_a, ["as", "variant", "weight", "color", "transform", "className", "truncate", "style"]);
