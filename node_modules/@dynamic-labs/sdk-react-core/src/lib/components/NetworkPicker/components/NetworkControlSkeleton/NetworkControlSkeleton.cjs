...
const NetworkControlSkeleton = ({ className, }) => (jsxRuntime.jsxs("div", { className: classNames.classNames('network-control-skeleton', className), "data-testid": 'network-control-loading', children: [jsxRuntime.jsx("div", { className: 'network-control-skeleton__icon' }), jsxRuntime.jsx(Skeleton.Skeleton, { className: 'network-control-skeleton__skeleton' })] }));
