...
export interface MigrationInterface extends Interface {
    getFunction(nameOrSignature: "convertFromV1ToDemurrage" | "hubV1" | "hubV2" | "inflationDayZero" | "migrate" | "period"): FunctionFragment;
    encodeFunctionData(functionFragment: "convertFromV1ToDemurrage", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "convertFromV1ToDemurrage", data: BytesLike): Result;
...
export interface Migration extends BaseContract {
    ...
    getFunction(nameOrSignature: "convertFromV1ToDemurrage"): TypedContractMethod<[_amount: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "hubV1"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "hubV2"): TypedContractMethod<[], [string], "view">;
