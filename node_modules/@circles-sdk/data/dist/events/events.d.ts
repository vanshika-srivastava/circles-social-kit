...
export type CirclesEvent = CrcV1_HubTransfer | CrcV1_Signup | CrcV1_OrganizationSignup | CrcV1_Trust | CrcV1_Transfer | CrcV2_InviteHuman | CrcV2_PersonalMint | CrcV2_RegisterGroup | CrcV2_RegisterHuman | CrcV2_RegisterOrganization | CrcV2_Stopped | CrcV2_Trust | CrcV2_TransferSingle | CrcV2_URI | CrcV2_ApprovalForAll | CrcV2_TransferBatch | CrcV2_RegisterShortName | CrcV2_UpdateMetadataDigest | CrcV2_CidV0 | CrcV2_StreamCompleted | CrcV2_CreateVault | CrcV2_GroupMintSingle | CrcV2_GroupMintBatch | CrcV2_GroupRedeem | CrcV2_GroupRedeemCollateralReturn | CrcV2_GroupRedeemCollateralBurn;
export type CirclesEventType = 'CrcV1_HubTransfer' | 'CrcV1_Signup' | 'CrcV1_OrganizationSignup' | 'CrcV1_Trust' | 'CrcV1_Transfer' | 'CrcV2_InviteHuman' | 'CrcV2_PersonalMint' | 'CrcV2_RegisterGroup' | 'CrcV2_RegisterHuman' | 'CrcV2_RegisterOrganization' | 'CrcV2_Stopped' | 'CrcV2_Trust' | 'CrcV2_TransferSingle' | 'CrcV2_URI' | 'CrcV2_ApprovalForAll' | 'CrcV2_TransferBatch' | 'CrcV2_RegisterShortName' | 'CrcV2_UpdateMetadataDigest' | 'CrcV2_CidV0' | 'CrcV2_StreamCompleted' | 'CrcV2_CreateVault' | 'CrcV2_GroupMintSingle' | 'CrcV2_GroupMintBatch' | 'CrcV2_GroupRedeem' | 'CrcV2_GroupRedeemCollateralReturn' | 'CrcV2_GroupRedeemCollateralBurn';
