...
export interface HubInterface extends Interface {
    getFunction(nameOrSignature: "deployedAt" | "divisor" | "inflation" | "initialIssuance" | "limits" | "name" | "organizations" | "period" | "seen" | "signupBonus" | "symbol" | "timeout" | "tokenToUser" | "userToToken" | "validation" | "periods" | "issuance" | "issuanceByStep" | "inflate" | "signup" | "organizationSignup" | "trust" | "pow" | "checkSendLimit" | "transferThrough"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "HubTransfer" | "OrganizationSignup" | "Signup" | "Trust"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "initialIssuance", values?: undefined): string;
    encodeFunctionData(functionFragment: "limits", values: [AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "name", values?: undefined): string;
    encodeFunctionData(functionFragment: "organizations", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "period", values?: undefined): string;
    encodeFunctionData(functionFragment: "seen", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "signupBonus", values?: undefined): string;
    encodeFunctionData(functionFragment: "symbol", values?: undefined): string;
    encodeFunctionData(functionFragment: "timeout", values?: undefined): string;
    encodeFunctionData(functionFragment: "tokenToUser", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "userToToken", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "validation", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "issuanceByStep", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "inflate", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "signup", values?: undefined): string;
    encodeFunctionData(functionFragment: "organizationSignup", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "checkSendLimit", values: [AddressLike, AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "transferThrough", values: [AddressLike[], AddressLike[], AddressLike[], BigNumberish[]]): string;
    ...
    decodeFunctionResult(functionFragment: "initialIssuance", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "signupBonus", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "symbol", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "timeout", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "tokenToUser", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "userToToken", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "issuanceByStep", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "organizationSignup", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "checkSendLimit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "transferThrough", data: BytesLike): Result;
}
export declare namespace HubTransferEvent {
    type InputTuple = [
        from: AddressLike,
        to: AddressLike,
        amount: BigNumberish
...
export declare namespace OrganizationSignupEvent {
    type InputTuple = [organization: AddressLike];
    type OutputTuple = [organization: string];
    interface OutputObject {
        organization: string;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export declare namespace SignupEvent {
    type InputTuple = [user: AddressLike, token: AddressLike];
    type OutputTuple = [user: string, token: string];
    interface OutputObject {
        user: string;
        token: string;
    }
...
export declare namespace TrustEvent {
    ...
    type OutputTuple = [canSendTo: string, user: string, limit: bigint];
    interface OutputObject {
        canSendTo: string;
        user: string;
        limit: bigint;
...
export interface Hub extends BaseContract {
    ...
    getFunction(nameOrSignature: "deployedAt"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "divisor"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "inflation"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "initialIssuance"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "organizations"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "period"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "seen"): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
    getFunction(nameOrSignature: "signupBonus"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "symbol"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "timeout"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "tokenToUser"): TypedContractMethod<[arg0: AddressLike], [string], "view">;
    getFunction(nameOrSignature: "userToToken"): TypedContractMethod<[arg0: AddressLike], [string], "view">;
    getFunction(nameOrSignature: "validation"): TypedContractMethod<[
        arg0: AddressLike
    ], [
        [
            boolean,
    ...
    getFunction(nameOrSignature: "periods"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "issuance"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "issuanceByStep"): TypedContractMethod<[_periods: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "inflate"): TypedContractMethod<[
        _initial: BigNumberish,
        _periods: BigNumberish
    ], [
        bigint
    ], "view">;
    getFunction(nameOrSignature: "signup"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "organizationSignup"): TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "checkSendLimit"): TypedContractMethod<[
        tokenOwner: AddressLike,
        src: AddressLike,
        dest: AddressLike
    ], [
    ...
    getFunction(nameOrSignature: "transferThrough"): TypedContractMethod<[
        tokenOwners: AddressLike[],
        srcs: AddressLike[],
        dests: AddressLike[],
        wads: BigNumberish[]
    ...
    getEvent(key: "HubTransfer"): TypedContractEvent<HubTransferEvent.InputTuple, HubTransferEvent.OutputTuple, HubTransferEvent.OutputObject>;
    getEvent(key: "OrganizationSignup"): TypedContractEvent<OrganizationSignupEvent.InputTuple, OrganizationSignupEvent.OutputTuple, OrganizationSignupEvent.OutputObject>;
    ...
    filters: {
        "HubTransfer(address,address,uint256)": TypedContractEvent<HubTransferEvent.InputTuple, HubTransferEvent.OutputTuple, HubTransferEvent.OutputObject>;
        HubTransfer: TypedContractEvent<HubTransferEvent.InputTuple, HubTransferEvent.OutputTuple, HubTransferEvent.OutputObject>;
        "OrganizationSignup(address)": TypedContractEvent<OrganizationSignupEvent.InputTuple, OrganizationSignupEvent.OutputTuple, OrganizationSignupEvent.OutputObject>;
        OrganizationSignup: TypedContractEvent<OrganizationSignupEvent.InputTuple, OrganizationSignupEvent.OutputTuple, OrganizationSignupEvent.OutputObject>;
        "Signup(address,address)": TypedContractEvent<SignupEvent.InputTuple, SignupEvent.OutputTuple, SignupEvent.OutputObject>;
