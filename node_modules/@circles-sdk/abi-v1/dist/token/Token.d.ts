...
export interface TokenInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "balanceOf" | "currentIssuance" | "decimals" | "decreaseAllowance" | "hub" | "increaseAllowance" | "inflationOffset" | "lastTouched" | "owner" | "totalSupply" | "transferFrom" | "time" | "symbol" | "name" | "period" | "periods" | "timeout" | "periodsWhenLastTouched" | "hubDeployedAt" | "stop" | "stopped" | "findInflationOffset" | "look" | "update" | "hubTransfer" | "transfer"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "Transfer"): EventFragment;
    encodeFunctionData(functionFragment: "allowance", values: [AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "approve", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "balanceOf", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "currentIssuance", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "inflationOffset", values?: undefined): string;
    encodeFunctionData(functionFragment: "lastTouched", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "periodsWhenLastTouched", values?: undefined): string;
    encodeFunctionData(functionFragment: "hubDeployedAt", values?: undefined): string;
    encodeFunctionData(functionFragment: "stop", values?: undefined): string;
    encodeFunctionData(functionFragment: "stopped", values?: undefined): string;
    encodeFunctionData(functionFragment: "findInflationOffset", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "hubTransfer", values: [AddressLike, AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "transfer", values: [AddressLike, BigNumberish]): string;
    decodeFunctionResult(functionFragment: "allowance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "approve", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "balanceOf", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "currentIssuance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "decimals", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "decreaseAllowance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hub", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "increaseAllowance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "inflationOffset", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "lastTouched", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "periodsWhenLastTouched", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hubDeployedAt", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "stop", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "stopped", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "findInflationOffset", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "look", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "update", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hubTransfer", data: BytesLike): Result;
...
export interface Token extends BaseContract {
    ...
    getFunction(nameOrSignature: "currentIssuance"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "inflationOffset"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "lastTouched"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "time"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "periodsWhenLastTouched"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "hubDeployedAt"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "findInflationOffset"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "look"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "update"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "hubTransfer"): TypedContractMethod<[
        from: AddressLike,
        to: AddressLike,
        amount: BigNumberish
    ], [
