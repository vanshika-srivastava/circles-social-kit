(function (factory) {
    ...
    class Hybridkem {
        ...
        async generateKeyPair() {
            ...
            return {
                publicKey: await this.deserializePublicKey((0, misc_js_1.concat)(new Uint8Array(pkA), new Uint8Array(pkB))),
                privateKey: await this.deserializePrivateKey((0, misc_js_1.concat)(new Uint8Array(skA), new Uint8Array(skB))),
            };
        }
        async deriveKeyPair(ikm) {
            const dkpPrk = await this._kdf.labeledExtract(consts_js_1.EMPTY, dhkemPrimitives_js_1.LABEL_DKP_PRK, new Uint8Array(ikm));
        ...
        async encap(params) {
            ...
            const pkRA = await this._a.deserializePublicKey(pkR.slice(0, this._a.publicKeySize));
            const pkRB = await this._b.deserializePublicKey(pkR.slice(this._a.publicKeySize));
            ...
            return {
                sharedSecret: (0, misc_js_1.concat)(new Uint8Array(resA.sharedSecret), new Uint8Array(resB.sharedSecret)),
        ...
        async decap(params) {
            ...
            const skRA = await this._a.deserializePrivateKey(skR.slice(0, this._a.privateKeySize));
            const skRB = await this._b.deserializePrivateKey(skR.slice(this._a.privateKeySize));
