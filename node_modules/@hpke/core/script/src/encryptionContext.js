(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./errors.js", "./exporterContext.js", "./utils/misc.js"], factory);
    }
    ...
    class EncryptionContextImpl extends exporterContext_js_1.ExporterContextImpl {
        ...
        computeNonce(k) {
            const seqBytes = (0, misc_js_1.i2Osp)(k.seq, k.baseNonce.byteLength);
            return xor(k.baseNonce, seqBytes);
        }
        incrementSeq(k) {
            // if (this.seq >= (1 << (8 * this.baseNonce.byteLength)) - 1) {
            if (k.seq > Number.MAX_SAFE_INTEGER) {
                throw new errors_js_1.MessageLimitReachedError("Message limit reached");
            }
            k.seq += 1;
            return;
        }
