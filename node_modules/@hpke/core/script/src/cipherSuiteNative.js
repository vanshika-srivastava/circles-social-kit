(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./algorithm.js", "./consts.js", "./errors.js", "./exporterContext.js", "./identifiers.js", "./recipientContext.js", "./senderContext.js", "./utils/misc.js"], factory);
    }
     ...
     * ```
     */
    class CipherSuiteNative extends algorithm_js_1.NativeAlgorithm {
        /**
        ...
        constructor(params) {
            ...
            if (typeof params.kem === "number") {
                throw new errors_js_1.InvalidParamError("KemId cannot be used");
            }
            this._kem = params.kem;
            // KDF
            if (typeof params.kdf === "number") {
                throw new errors_js_1.InvalidParamError("KdfId cannot be used");
            }
            this._kdf = params.kdf;
            // AEAD
            if (typeof params.aead === "number") {
                throw new errors_js_1.InvalidParamError("AeadId cannot be used");
            }
            this._aead = params.aead;
            this._suiteId = new Uint8Array(SUITE_ID_HEADER_HPKE);
            this._suiteId.set((0, misc_js_1.i2Osp)(this._kem.id, 2), 4);
            this._suiteId.set((0, misc_js_1.i2Osp)(this._kdf.id, 2), 6);
            this._suiteId.set((0, misc_js_1.i2Osp)(this._aead.id, 2), 8);
        ...
        async createSenderContext(params) {
            ...
            if (params.psk !== undefined) {
                mode = params.senderKey !== undefined ? identifiers_js_1.Mode.AuthPsk : identifiers_js_1.Mode.Psk;
            }
            else {
                mode = params.senderKey !== undefined ? identifiers_js_1.Mode.Auth : identifiers_js_1.Mode.Base;
            }
        ...
        async createRecipientContext(params) {
            ...
            let mode;
            if (params.psk !== undefined) {
                mode = params.senderPublicKey !== undefined ? identifiers_js_1.Mode.AuthPsk : identifiers_js_1.Mode.Psk;
            }
            else {
                mode = params.senderPublicKey !== undefined ? identifiers_js_1.Mode.Auth : identifiers_js_1.Mode.Base;
            }
         ...
         */
        async seal(params, pt, aad = consts_js_1.EMPTY) {
         ...
         */
        async open(params, ct, aad = consts_js_1.EMPTY) {
        ...
        async _keySchedule(mode, sharedSecret, params) {
            ...
            const pskIdHash = await this._kdf.labeledExtract(consts_js_1.EMPTY, LABEL_PSK_ID_HASH, pskId);
            const info = params.info === undefined
                ? consts_js_1.EMPTY
                : new Uint8Array(params.info);
            const infoHash = await this._kdf.labeledExtract(consts_js_1.EMPTY, LABEL_INFO_HASH, info);
            ...
            if (this._aead.id === identifiers_js_1.AeadId.ExportOnly) {
        ...
        _validateInputLength(params) {
            if (params.info !== undefined &&
                params.info.byteLength > consts_js_1.INPUT_LENGTH_LIMIT) {
                throw new errors_js_1.InvalidParamError("Too long info");
            }
            if (params.psk !== undefined) {
                if (params.psk.key.byteLength < consts_js_1.MINIMUM_PSK_LENGTH) {
                    throw new errors_js_1.InvalidParamError(`PSK must have at least ${consts_js_1.MINIMUM_PSK_LENGTH} bytes`);
                }
                if (params.psk.key.byteLength > consts_js_1.INPUT_LENGTH_LIMIT) {
                    throw new errors_js_1.InvalidParamError("Too long psk.key");
                }
                if (params.psk.id.byteLength > consts_js_1.INPUT_LENGTH_LIMIT) {
                    throw new errors_js_1.InvalidParamError("Too long psk.id");
                }
            }
            return;
        }
