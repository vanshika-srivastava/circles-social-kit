(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../algorithm.js", "../identifiers.js", "../interfaces/aeadEncryptionContext.js"], factory);
    }
    ...
    const aeadEncryptionContext_js_1 = require("../interfaces/aeadEncryptionContext.js");
    class AesGcmContext extends algorithm_js_1.NativeAlgorithm {
        constructor(key) {
            super();
        ...
        async _importKey(key) {
            return await this._api.importKey("raw", key, { name: "AES-GCM" }, true, aeadEncryptionContext_js_1.AEAD_USAGES);
        }
    }
    ...
    class Aes128Gcm {
        constructor() {
            ...
            Object.defineProperty(this, "id", {
                ...
                configurable: true,
                writable: true,
                value: identifiers_js_1.AeadId.Aes128Gcm
            });
            /** 16 */
    ...
    class Aes256Gcm extends Aes128Gcm {
        constructor() {
            ...
            Object.defineProperty(this, "id", {
                ...
                configurable: true,
                writable: true,
                value: identifiers_js_1.AeadId.Aes256Gcm
            });
            /** 32 */
            Object.defineProperty(this, "keySize", {
                enumerable: true,
