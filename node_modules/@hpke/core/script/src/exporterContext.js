(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./consts.js", "./errors.js", "./utils/emitNotSupported.js"], factory);
    }
    ...
    class ExporterContextImpl {
        ...
        async export(exporterContext, len) {
            if (exporterContext.byteLength > consts_js_1.INPUT_LENGTH_LIMIT) {
                throw new errors_js_1.InvalidParamError("Too long exporter context");
            }
            try {
                return await this._kdf.labeledExpand(this.exporterSecret, LABEL_SEC, new Uint8Array(exporterContext), len);
            }
            catch (e) {
                throw new errors_js_1.ExportError(e);
            }
        }
    }
